...
namespace RazorPages.Migrations
{
    ...
    [Migration("20221102035242_ClientAndAnnotations")]
            ...
            modelBuilder.Entity("RazorPages.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2022, 11, 1, 23, 52, 42, 19, DateTimeKind.Local).AddTicks(7827),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2022, 11, 1, 23, 52, 42, 23, DateTimeKind.Local).AddTicks(9156),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2022, 11, 1, 23, 52, 42, 23, DateTimeKind.Local).AddTicks(9238),
                            ServicesID = 5
                        });
                });
